...
class Client implements Runnable {
    ...
    private static final int STATUS_TIMER = 1000 * 20;
    ...
    /**
     * @param args -s [server ip] -p [server port] -T [TCP] -U [UDP] -I [Interactive]
     */
                    ...
                    do {
                        ...
                        switch (input) {
                            ...
                            case "3":
                                ...
                                Arrays.stream(peers).forEach(peer -> System.out.println(" " + peer));
                                System.out.println();
                                break;
                            case "4":
                                break;
    ...
    private void $$$setupUI$$$() {
        ...
        gossipButton.setHorizontalTextPosition(SwingConstants.CENTER);
        ...
        connectionMessage.setHorizontalAlignment(SwingConstants.CENTER);
        connectionMessage.setHorizontalTextPosition(SwingConstants.CENTER);
